# HuggingFace Quickstart - BERT example
...
with torch.no_grad():
    ...
    # In our case, the first element is the hidden state of the last layer of
    # the Bert model
    encoded_layers = outputs[0]

# We have encoded our input sequence in a FloatTensor of shape [batch_size,
# seq.length, hidden_dim]
